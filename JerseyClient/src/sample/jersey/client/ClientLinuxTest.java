...
//		QueryProgress(r,time,"C:\\1.jpg","1053","false");
...
//		QueryProgress(r,time,"C:\\1.jpg","830","false");
...
//		QueryProgress(r,time,"C:\\1.jpg","1023","false");
//		getCodeInfo(r,time,"0x0100C00");
...
//		vmScriptLinux(r, time, "C:\\Users\\abc\\Desktop\\script.bat");
		...
		//changePWDLinux(r,time);
//		getASystemServiceState(r,time);//获取单个服务状态
//		getallSystemServiceState(r,time);//获取全部服务状态
...
//				.queryParam("softName", "memcached-1.4.15")
	...
	private static void installOracle11gLinux(WebResource r, String time) {
		...
		String response = r
				...
				.queryParam("oraclebase", "/home/u01/app/oracle")
				.queryParam("oracleinventory", "oraInventory")
				.queryParam("oraclehome", "product")
				.queryParam("oracle_sid", "orcl")
				.queryParam("rootPswd", "123456QWq")
				.queryParam("oradata", "oradata")
				.queryParam("version", "")
				.queryParam("cover", "YES")
				.header("password", "EDGM@MAMABDACFDLLG")
				.header("time", time).type(MediaType.APPLICATION_JSON)
