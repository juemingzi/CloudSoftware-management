...
public class Test_Win {
	...
	public static void main(String[] args) {
		...
		//QueryProgress(r,time,"C:\\1.jpg","411","false");
		//getCodeInfo(r,time,"0x0100204");
		...
		//installOracle11g(r,time);//安装前手动解压到相应文件夹，文件夹已经建好，在虚拟机中，注意空间至少留10G
		...
		//installSQLServer2008R2(r,time);//在安装的时候手动解压到相应位置，文件夹已经在虚拟机建好，注意他的安装空间至少要预留12——13G
										//安装成功后重启在命令行输入sql /?来验证是否安装成功。
		//interfaceInstallSQLServer2008R2(r,time);//同上
		//uninstallSQLServer2008R2(r,time);
			
		//QueryProgress(r,time,"C:\\1.jpg","786","false");
		//getCodeInfo(r,time,"0x0100A00");
		//reboot(r,time);
		// 调用代码
		//changePWD(r, time);	
		//changeIP(r, time);
		...
		//getCodeInfo(r,time,"0x0500000");
		//changeSecRules(r,time);
		//startOrStopService(r,time);
		
		//getSystemServiceState(r, time);
		//getServiceState(r,time);
