...
/**
 * @ClassName: WStatusGetHandle
 * @Description: 获取下载进度
 * @author: wangyannan
 * @date: 2015-1-17 上午11:54:08
 */
public class WStatusGetHandle {

	/**
	 * @Title:WStatusGetHandle
	 * @Description:获取下载进度线程
	 * @param socket
	 */
	public WStatusGetHandle(final Socket socket) {
			...
			public void run() {
				...
				try {
					...
					if (!AESUtil.isErrorKey(str1)) {
						 ...
						 * 获取文件大小
						 */
						String storePath = new String("C:/softsource/");
						File file = new File("C:/softsource/" + fileName);
						String path;
